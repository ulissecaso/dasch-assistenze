...
export default function MonitorBoard({
  ...
  const righeVisibili = soloUrgenti ? alertRows.filter((r) => r.livello === "critica") : alertRows;
...
const CSS = `
.mon-wrap{background:#0a0e16;}
.mon-wrap:fullscreen{overflow:auto;padding:22px 28px;}
.monitor-board{background:#0a0e16;color:#e5e7eb;padding:22px 28px;border-radius:16px;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;}
.mon-topbar{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:14px;}
...
.mon-header{display:flex;justify-content:space-between;align-items:center;gap:20px;margin-bottom:18px;flex-wrap:wrap;}
.mon-header h1{color:#fff;font-size:34px;line-height:1.15;letter-spacing:.3px;margin:0;text-align:right;}
.op-row{display:flex;flex-wrap:wrap;gap:12px;}
.op-card{width:210px;border-radius:12px;padding:10px 12px;background:#0f1420;border:1.5px solid;}
.op-card-top{display:flex;align-items:center;gap:10px;margin-bottom:8px;}
...
.mon-section-title{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;flex-wrap:wrap;gap:8px;}
...
.mon-table-wrap{background:#0f1420;border:1px solid #1e2634;border-radius:14px;overflow:hidden;margin-bottom:16px;overflow-x:auto;}
.mon-empty{padding:26px;color:#8b96a8;font-size:13.5px;}
.mon-table{width:100%;border-collapse:collapse;font-size:13px;}
.mon-table th{text-align:left;color:#8b96a8;font-weight:600;font-size:11px;letter-spacing:.4px;text-transform:uppercase;padding:12px 14px;border-bottom:1px solid #1e2634;background:#0c111c;}
.mon-table td{padding:12px 14px;border-bottom:1px solid #171e2b;color:#e5e7eb;vertical-align:middle;}
...
.mon-stats{display:grid;grid-template-columns:repeat(5,1fr);gap:14px;}
.mon-stat{background:#0f1420;border:1px solid #1e2634;border-radius:12px;padding:16px 18px;}
.mon-stat .lbl{display:flex;align-items:center;gap:10px;font-size:11.5px;font-weight:700;letter-spacing:.4px;margin-bottom:10px;}
.mon-stat .val{color:#fff;font-size:22px;font-weight:700;}
.mon-stat .val small{font-size:12px;font-weight:500;color:#8b96a8;margin-left:4px;}
.ic{display:inline-flex;width:16px;height:16px;vertical-align:middle;flex-shrink:0;}
.mon-stat .lbl .ic{width:32px;height:32px;}
.mon-stat .lbl .ic-bell{width:36px;height:36px;}
.ic-red{color:#f87171;}
